...
public class AjouterTravailActivity extends AppCompatActivity {
    ...
    private void initialiserComposant(){
        editTextDescription = findViewById(R.id.Descript);
        editTextPromotion = findViewById(R.id.Promot);
        editTextCategory = findViewById(R.id.Promot);
        editTextDateTravail = findViewById(R.id.Trav);
        buttonAjouterPhoto = findViewById(R.id.ajPh);
        buttonAjouterTravail = findViewById(R.id.AjNomP);
    }
